...
public class Store {
    ...
    public void initializeInventory() {
        ...
        inventory_.put_item((new Cassette("Guns 'N Roses Cassette", 1, 2, true, 0, new Condition("excellent"), 0, "Guns 'N Roses", "Appetite for Destruction")));
        inventory_.put_item((new Cassette("Iron Maiden Cassette", 1, 2, true, 0, new Condition("very good"), 0, "Iron Maiden", "Powerslave")));
        inventory_.put_item((new Cassette("Black Sabbath Cassette", 1, 2, false, 0, new Condition("excellent"), 0, "Black Sabbath", "Paranoid")));
        inventory_.put_item((new CD_Player("Sony CDPlayer", 30, 60, true, 0, new Condition("excellent"), 0, "Sony", false)));
        inventory_.put_item((new CD_Player("LG CDPlayer", 30, 60, true, 0, new Condition("excellent"), 0, "LG", false)));
        inventory_.put_item((new CD_Player("Logitech CDPlayer", 30, 60, true, 0, new Condition("excellent"), 0, "Logitech", false)));
        inventory_.put_item((new RecordPlayer("Logitech RecordPlayer", 20, 40, true, 0, new Condition("very good"), 0, "Logitech", false)));
        inventory_.put_item((new RecordPlayer("LG RecordPlayer", 20, 40, true, 0, new Condition("fair"), 0, "LG", false)));
        inventory_.put_item((new RecordPlayer("Sony RecordPlayer", 20, 40, true, 0, new Condition("good"), 0, "Sony", false)));
        inventory_.put_item((new MP3Player("Logitech MP3Player", 20, 40, true, 0, new Condition("very good"), 0, "Logitech", false)));
        inventory_.put_item((new MP3Player("LG MP3Player", 20, 40, true, 0, new Condition("fair"), 0, "LG", false)));
        inventory_.put_item((new MP3Player("Sony MP3Player", 20, 40, true, 0, new Condition("good"), 0, "Sony", false)));
        inventory_.put_item((new CassettePlayer("Logitech CassettePlayer", 20, 40, true, 0, new Condition("very good"), 0, "Logitech", false)));
        inventory_.put_item((new CassettePlayer("LG CassettePlayer", 20, 40, true, 0, new Condition("fair"), 0, "LG", false)));
        inventory_.put_item((new CassettePlayer("Sony CassettePlayer", 20, 40, true, 0, new Condition("good"), 0, "Sony", false)));
        inventory_.put_item((new Guitar("Gibson SG Guitar", 45, 90, true, 0, new Condition("excellent"), 0, "Gibson", true, false)));
        inventory_.put_item((new Guitar("Fender Stratocaster Guitar", 40, 80, false, 0, new Condition("good"), 0, "Fender", true, false)));
        inventory_.put_item((new Guitar("Ibanez Guitar", 40, 80, true, 0, new Condition("very good"), 0, "Ibanez", true, false)));
        inventory_.put_item((new Bass("Fender Precision Bass", 35, 70, true, 0, new Condition("excellent"), 0, "Fender", true, false)));
        inventory_.put_item((new Bass("Gibson Thunderbird Bass", 30, 60, true, 0, new Condition("fair"), 0, "Gibson", true, false)));
        inventory_.put_item((new Bass("Modulus Bass", 40, 80, true, 0, new Condition("excellent"), 0, "Modulus", true, false)));
        inventory_.put_item((new Mandolin("Kentucky Mandolin", 25, 50, false, 0, new Condition("excellent"), 0, "Kentucky", false, false)));
        inventory_.put_item((new Mandolin("Gibson Mandolin", 25, 50, false, 0, new Condition("fair"), 0, "Gibson", false, false)));
        inventory_.put_item((new Mandolin("Goldtone Mandolin", 25, 50, true, 0, new Condition("excellent"), 0, "Goldtone", false, false)));
        inventory_.put_item((new Flute("Etude Flute", 20, 40, true, 0, new Condition("good"), 0, "Etude", "Alto", false)));
        inventory_.put_item((new Flute("Yamaha Flute", 20, 40, true, 0, new Condition("good"), 0, "Yamaha", "C", false)));
        inventory_.put_item((new Flute("Azumi Flute", 20, 40, false, 0, new Condition("good"), 0, "Azume", "Wooden", false)));
        inventory_.put_item((new Saxophone("Etude Saxophone", 20, 40, true, 0, new Condition("good"), 0, "Etude", "Alto", false)));
        inventory_.put_item((new Saxophone("Yamaha Saxophone", 20, 40, true, 0, new Condition("good"), 0, "Yamaha", "Tenor", false)));
        inventory_.put_item((new Saxophone("Azumi Saxophone", 20, 40, false, 0, new Condition("good"), 0, "Azume", "Soprano", false)));
        inventory_.put_item((new Harmonica("Hohner Harmonica", 10, 20, false, 0, new Condition("very good"), 0, "Hohner", "C", false)));
        inventory_.put_item((new Harmonica("Lee Oskar Harmonica", 10, 20, false, 0, new Condition("very good"), 0, "Lee Oskar", "C", false)));
        inventory_.put_item((new Harmonica("SEYDEL Blues Harmonica", 10, 20, false, 0, new Condition("very good"), 0, "SEYDEL", "C", false)));
